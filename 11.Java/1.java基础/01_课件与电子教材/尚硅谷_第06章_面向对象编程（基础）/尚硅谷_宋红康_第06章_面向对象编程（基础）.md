...
这个总结的过程，其实是`抽象化`的过程。抽象出来的美人鱼的特征，可以归纳为一个`美人鱼类`。而上面图片中的都是这个类呈现出来的`具体的对象`。
...
![image-20211228115855484](images/image-20211228115855484.png)
...
<img src="images/image-20220320231755654.png" alt="image-20220320231755654" style="zoom:67%;" />
...
![image-20220320232011272](images/image-20220320232011272.png)
